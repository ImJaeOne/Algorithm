...
### 문제 풀이
sort를 이용해서 알파벳을 오름차순으로 정렬합니다. 대문자와 소문자 중 대문자가 앞에 위치합니다. 알파벳은 sort((a, b) => b - a)를 통해서 바로 내림차순으로 정렬 불가능하기 때문에 reverse를 이용해 내림차순으로 풀이하였습니다.
